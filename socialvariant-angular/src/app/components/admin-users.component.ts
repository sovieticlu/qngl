      ...
      <div class="container">
        <header class="page-header">
          <nav class="breadcrumb">
            ...
            <span class="current">{{ translate('admin.users') }}</span>
          </nav>
          <h1>{{ translate('admin.user_management') }}</h1>
        </header>

        <div class="content-placeholder">
          <div class="placeholder-icon">👥</div>
          <h2>{{ translate('admin.user_management_coming_soon') }}</h2>
...
export class AdminUsersComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.documentHeadService.updateHead({
      title: this.translate('admin.user_management'),
      description: this.translate('admin.user_management_description'),
